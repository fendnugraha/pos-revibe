...
const CreateExpense = ({ accounts, range, fetchRevenueByWarehouse, fetchJournalByWarehouse, isModalOpen, notification, today, warehouseId }) => {
    ...
    const expense = accounts.filter((account) => account.account.type === "Expenses");
